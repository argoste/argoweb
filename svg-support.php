...
$en_title = "Is SVG support working?";
$it_title = $en_title;

$en_content = <<< EN_CONTENT
  <h1>Is SVG support working?</h1>
  <p>There are many ways of using SVG in HTML5:</p>
  <ol>
  <li>Using the <code>object</code> tag,</li>
    <object data="img/simbolo.svg" type="image/svg+xml">SVG file here</object>
  <li>using the <code>embed</code> tag,</li>
    <embed src="img/simbolo.svg" type="image/svg+xml" />
